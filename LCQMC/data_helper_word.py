...
# train_q1, train_q2, train_label = read_data('./data/break_word/LCQMC_train1.txt')
# test_q1, test_q2, test_label = read_data('./data/break_word/LCQMC_test1.txt')
# dev_q1, dev_q2, dev_label = read_data('./data/break_word/LCQMC_dev1.txt')
...
w2v_model.save('w2v_model_word.pkl')
...
save_pickle(corpus, 'corpus_word.pkl')
save_pickle(model_data, 'model_data_word.pkl')
save_pickle(embedding_matrix, 'embedding_matrix_word.pkl')
save_pickle(tokenizer, 'tokenizer_word.pkl')
